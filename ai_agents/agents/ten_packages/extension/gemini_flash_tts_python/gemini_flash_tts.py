...
class GeminiFlashTTSClient(AsyncTTS2HttpClient):
    def __init__(
        self,
        ...
        self.config: GeminiFlashTTSConfig = config
        self.client = None
    ...
    async def get(
        ...
        try:
            ...
            if not self.client:
                ...
                self.ten_env.log_debug("Gemini Flash TTS client initialized")
            ...
            if (
                ...
                if hasattr(part, "inline_data") and part.inline_data:
                    ...
                    error_msg = (
                        "No audio data in response from Gemini Flash TTS"
                    )
                ...
                error_msg = "Empty response received from Gemini Flash TTS"
                self.ten_env.log_error(error_msg)
    ...
    async def cancel(self):
        ...
        self.ten_env.log_info("Cancelling Gemini Flash TTS request")
        self._is_cancelled = True

    async def clean(self):
        """Clean up resources"""
        self.ten_env.log_info("Cleaning up Gemini Flash TTS client")
        self._is_cancelled = False
        self.client = None
