...
class OpenAIChatGPT:
    ...
    async def get_chat_completions(
        ...
        req = {
            ...
            # "presence_penalty": self.config.presence_penalty,  # Not supported by current model
            # "frequency_penalty": self.config.frequency_penalty,  # Not supported by current model
    ...
    async def get_chat_completions_stream(
        ...
        req = {
            ...
            "max_completion_tokens": self.config.max_tokens,
            "seed": self.config.seed,
            "stream": False,  # Disabled due to organization verification requirement
        }
        ...
        # Handle non-streaming response (single ChatCompletion object)
